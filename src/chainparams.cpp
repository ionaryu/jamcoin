...
{
    const char* pszTimestamp = "NY Times 25/Dec/2021 How to Watch the James Webb Space Telescope Launch";
...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.jamcoin.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.jamcointools.com");
        vSeeds.emplace_back("dnsseed.jamcoinpool.org");
        ...
        // base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x88, 0xB6, 0x1E};
        // base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x88, 0xAE, 0xE4};
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.jamcointools.com");
        vSeeds.emplace_back("seed-b.jamcoin.loshan.co.uk");
