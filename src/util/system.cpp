...
const char * const BITCOIN_CONF_FILENAME = "jamcoin.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Jamcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Jamcoin";
#else
    // Unix
    return pathRet / ".jamcoin";
#endif
#endif
}
