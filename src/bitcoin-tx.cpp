...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " jamcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  jamcoin-tx [options] <hex-tx> [commands]  Update hex-encoded jamcoin transaction\n" +
            "or:     jamcoin-tx [options] -create [commands]   Create hex-encoded jamcoin transaction\n" +
            "\n";
