Jamcoin Core version *0.15.1* is now available from:

  <https://download.jamcoin.org/jamcoin-0.15.1/>
...
A number of changes to the way Jamcoin Core deals with peer connections and invalid blocks
...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 leptons per kB (0.00001 JMC). This is to prepare for dropping the minimum transaction fee to 0.1 leptons per kB (0.0001 JMC) in the next release.
