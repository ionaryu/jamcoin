# Support for Output Descriptors in Jamcoin Core

Since Jamcoin Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `jmc1...` for mainnet or `tjmc1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
on Jamcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Jamcoin Core wallets, a convenience function `combo` is
