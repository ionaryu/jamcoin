...
"""Verify that starting jamcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start jamcoin with -h for help text")
        ...
        self.log.info("Start jamcoin with -version for version information")
        ...
        self.log.info("Start jamcoind with -fakearg to make sure it does not start")
