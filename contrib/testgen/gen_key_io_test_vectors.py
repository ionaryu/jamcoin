...
bech32_templates = [
  ...
  ('jmc',   0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('jmc',   0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('jmc',   1,  2, (False, 'main',    None, True), (OP_1, 2)),
  ('tjmc',  0, 20, (False, 'test',    None, True), p2wpkh_prefix),
  ('tjmc',  0, 32, (False, 'test',    None, True), p2wsh_prefix),
  ('tjmc',  2, 16, (False, 'test',    None, True), (OP_2, 16)),
  ('rjmc',  0, 20, (False, 'regtest', None, True), p2wpkh_prefix),
  ('rjmc',  0, 32, (False, 'regtest', None, True), p2wsh_prefix),
  ('rjmc', 16, 40, (False, 'regtest', None, True), (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, invalid_bech32, invalid_checksum, invalid_char
  ('tc',    0, 20, False, False, False),
  ('tjmc',  17, 32, False, False, False),
  ('rjmc',  3,  1, False, False, False),
  ('jmc',   15, 41, False, False, False),
  ('tjmc',  0, 16, False, False, False),
  ('rjmc',  0, 32, True,  False, False),
  ('jmc',   0, 16, True,  False, False),
  ('tjmc',  0, 32, False, True,  False),
  ('rjmc',  0, 20, False, False, True)
]
